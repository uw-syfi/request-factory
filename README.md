...
do not currently score model output quality. Synthetic image, audio, and video
inputs are generated by Request Factory and require no dataset. Synthetic video
is intended for upload-path testing; use real assets when the server must decode
frames.
